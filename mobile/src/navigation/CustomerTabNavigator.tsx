...
export type CustomerMarketplaceStackParamList = {
...
export type CustomerTabParamList = {
  ...
  Inquiries: { inquiryId?: string } | undefined;
  Profile: undefined;
};

const MarketplaceStack = createNativeStackNavigator<CustomerMarketplaceStackParamList>();
...
function MarketplaceStackNavigator() {
  return (
    ...
    >
      <MarketplaceStack.Screen name="MarketplaceFeed" component={MarketplaceScreen} />
