 ...
 * call is actually made. In Expo Go the
...
export const DEV_AUTH_ENABLED =
  ...
  __DEV__ &&
  (process.env.EXPO_PUBLIC_DEV_AUTH_ENABLED === 'true' || Constants.appOwnership === AppOwnership.Expo);

// Provider selection is the runtime/platform boundary:
//  - Expo Go development (detected through expo-constants, or explicitly enabled) →
//    DevAuthProvider.
